		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#inboxworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inboxworkflowuimodule-display": {
								"semanticObject": "inboxworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=inbox.workflowuimodule",
									"url": sap.ui.require.toUrl("inbox/workflowuimodule")
								}
							}
						}
					}
