		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#inboxworkflowtask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inboxworkflowtask-display": {
								"semanticObject": "inboxworkflowtask",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=inbox.workflowtask",
									"url": sap.ui.require.toUrl("inbox/workflowtask")
								}
							}
						}
					}
